...
export default ({ isVisible }) => {
  ...
  return (
    <TextContainer ref={containerRef}>
      <Title ref={titleRef}>4 / The arrival</Title>
      <Text ref={textRef}>Its time!  Minting occurs. Asters are now part of the blockchain. Let's explore together the infinite possibilities of the metaverse.</Text>
    </TextContainer>
  );
};
