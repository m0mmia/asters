...
export default ({ isVisible }) => {
  ...
  return (
    <TextContainer ref={containerRef}>
      <Title ref={titleRef}>1 / First contact</Title>
      <Text ref={textRef}>Here, you can interact with the Asters community on Discord and Twitter. An advisor board helps moderate these channels to create authentic connections. We open the Whitelist and set the guidelines to guarantee day-one access to your Aster avatar.  </Text>
    </TextContainer>
  );
};
