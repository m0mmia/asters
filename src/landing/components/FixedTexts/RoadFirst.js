...
export default ({ isVisible }) => {
  ...
  return (
    <TextContainer ref={containerRef}>
      <Title ref={titleRef}> 2/ Join the hub</Title>
      <Text ref={textRef}>Asters website is officially online. Discord and Twitter spaces bloom with exclusive live events and pre-launch initiatives to boost our community.</Text>
    </TextContainer>
  );
};
